...
numbInt = int(sys.argv[2])

# choosing the type
input_dir_path = "./"
if (typeInt == 1): 
  input_dir_path = "dotgridinteriorpages"
elif (typeInt == 2): 
  input_dir_path = "graphinteriorpages"
elif (typeInt == 3): 
  input_dir_path = "linedinteriorpages"
else: 
...
output_path = input_dir_path + "_" + str(numbInt) + "_" + input_final_path
