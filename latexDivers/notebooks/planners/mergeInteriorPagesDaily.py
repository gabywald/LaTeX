...
"""
Description: [Daily Planner]Merging sample page of [dot|graph|lined] Interior Pages to same booklet (for more than one page). 
...
numbInt = 366 # default to 366 days
...
# choosing the type of second page
input_dir_path = "./"
input_dir_path = "dailyplannerinteriorpages"
...
basicModelPage0 = pdf_reader.pages[0]
basicModelPage1 = pdf_reader.pages[1]
...
for x in range( numbInt ):
  pdf_writer.add_page( basicModelPage0 )
  pdf_writer.add_page( basicModelPage1 )
pdf_writer.add_page( basicModelPageGraph )
for x in range( 66 ): # 366*2 + 2 + 
  pdf_writer.add_page( basicModelPageGraph )
