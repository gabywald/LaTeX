...
"""
Description: [Monthly Planner]Merging sample page of [dot|graph|lined] Interior Pages to same booklet (for more than one page). 
...
numbInt = 12 # default to 12 monthes
...
# choosing the type of second page
input_dir_path = "./"
input_dir_path = "monthlyplannerinteriorpages"
