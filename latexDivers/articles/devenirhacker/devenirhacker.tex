...
\usepackage{vmargin}
\setmarginsrb{1.00cm}{1.00cm}{1.00cm}{1.00cm}{15pt}{3pt}{45pt}{20pt}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE,RO]{ \centering \textbf{Comment devenir Hacker ? Suivez le guide !} }
\fancyfoot[LE]{
	\thepage \hfill
	\textit{Comment devenir hacker // Alchimiste de l'informatique} 
	\hfill \includegraphics[width=0.35cm]{img/glider.png} }
\fancyfoot[RO]{
	\includegraphics[width=0.35cm]{img/glider.png} 
	\hfill \textit{Comment devenir hacker // Alchimiste de l'informatique} 
	\hfill \thepage }
