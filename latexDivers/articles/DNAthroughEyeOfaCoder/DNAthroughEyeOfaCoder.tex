...
\begin{center}
	...
	~\\
	\texttt{http://ds9a.nl/amazing-dna/} / \texttt{https://berthub.eu/articles/posts/amazing-dna/}
\end{center}

\textsc{TODO document to be updated with new data from 2017 to 2021 and more !}~\\

``\emph{This is one of the coolest things I've read in a while.} '' -- -- \texttt{jwz}~\footnote{\texttt{http://www.livejournal.com/users/jwz/}} ~\\

This is just some rambling by a computer programmer about DNA. I'm not a molecular geneticist. If you spot the inevitable mistakes, please mail me (\texttt{bert hubert}~\footnote{\texttt{http://ds9a.nl/}}) at \texttt{ahu@ds9a.nl}. I'm not trying to force my view unto the DNA -- each observation here is quite 'uncramped'. To see where I got all this from, head to the bibliography. %% ~\\ 
