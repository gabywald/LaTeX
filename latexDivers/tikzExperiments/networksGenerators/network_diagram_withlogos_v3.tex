...
%% pdflatex network_diagram_withlogos_v3.tex && rm *.aux *.log
...
\begin{tikzpicture}[node distance=2cm, auto]
	...
	% Nodes
	\node[server] (Server1) {Server1} ;
	\node[terminal] [right=of Server1] (Terminal1) {Terminal1} ;
	\node[router] [below=of Server1] (Router1) {Router1} ;
	\node[firewall] [right=of Router1] (Firewall1) {Firewall1} ;
	\node[server] [below=of Router1] (Server2) {Server2} ;
	\node[terminal] [right=of Server2] (Terminal2) {Terminal2} ;
	\node[router] [below=of Terminal2] (Router2) {Router2} ;
	\node[firewall] [left=of Router2] (Firewall2) {Firewall2} ;
	\node[server] [left=of Firewall2] (Server3) {Server3} ;
	\node[terminal] [above=of Server3] (Terminal3) {Terminal3} ;
	\node[ai] [left=of Router1] (AI00) {} ;
	\node[mainframe] [above=of AI00] (MF00) {} ;
	%% \node[ai] [left=of Router1] (AI00) {AI00} ;
	%% \node[mainframe] [above=of AI00] (MF00) {MF00} ;
	...
	\path [draw, -latex'] (AI00) -- (MF00);
	\path [draw, -latex'] (MF00) -- (AI00);
