...
%% pdflatex network_diagram_withlogos.tex && rm *.aux *.log
...
\begin{tikzpicture}[node distance=2cm, auto]
    ...
    % Nodes
    \node (Server1) {\TIKZnodeSERVER};
    \node [right=of Server1] (Terminal1) {\TIKZnodeTERMINAL};
    \node [below=of Server1] (Router1) {\TIKZnodeROUTER};
    \node [right=of Router1] (Firewall1) {\TIKZnodeFIREWALL};
    \node [below=of Router1] (Server2) {\TIKZnodeSERVER};
    \node [right=of Server2] (Terminal2) {\TIKZnodeTERMINAL};
    \node [below=of Terminal2] (Router2) {\TIKZnodeROUTER};
    \node [left=of Router2] (Firewall2) {\TIKZnodeFIREWALL};
    \node [left=of Firewall2] (Server3) {\TIKZnodeSERVER};
    \node [above=of Server3] (Terminal3) {\TIKZnodeTERMINAL};
