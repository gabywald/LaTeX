...
\end{minipage} \hfill \begin{minipage}[ht]{0.45\textwidth}
	...
	\begin{tikzpicture}
		\draw[red,thick](0,0)\triangle; %% FEU
		
		\draw[blue,thick](2,0)\triangle (1,0.40)--(2,0.40); %% AIR
		
		\draw[orange,thick](3,1)--(4,1)\triangleReverse; %% EAU
		
		\draw[green,thick](5,1)--(6,1)\triangleReverse (5,0.60)--(6,0.60); %% TERRE
	\end{tikzpicture}
