...
\date{23 f{\'e}vrier 2019} %% \date{\today} %% \date{08 Novembre 2010}
...
\subsubsection{\sectionPartIIaV} %% DONE Majestic => insister sur aspect transmedia ?!
\begin{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item[] ...
		\item Des id{\'e}es ?
		%% \item<2> Tests de s{\'e}curit{\'e} / CyberS{\'e}curit{\'e}
	\end{itemize}
\end{frame} 
