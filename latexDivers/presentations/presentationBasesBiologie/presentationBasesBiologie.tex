...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Animaux : Mitochondries (g{\'e}nome sp{\'e}cifique pour certains constituants du m{\'e}tabolisme {\'e}nerg{\'e}tique) ;
			\item Plantes : Mitochondries ET Chloroplastes (interaction lumi{\`e}re-mati{\`e}re, g{\'e}nomes sp{\'e}cifiques) ; 
		\end{itemize}
...
\begin{frame}
	...
	\end{minipage} \hfill \begin{minipage}[ht]{0.45\linewidth}
		\begin{itemize}
			...
			\item ARNr (ribosomal)
			\item ARNt (transfert)
			\item {\'E}pissage (supression des introns et conservation des introns, chez les eukaryotes). 
			\item {\'E}pissage alternatif (un seul ARNm issu du m{\^e}me g{\`e}ne peut donner plusieurs prot{\'e}ines).
		\end{itemize}
	\end{minipage} 
