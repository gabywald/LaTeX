...
\def\titleSubSectionMilieuNaturel{Cr{\'e}ativit{\'e} Informatique en milieu naturel}
\subsection{\titleSubSectionMilieuNaturel }
\begin{frame}
	\frametitle{\titleSubSectionMilieuNaturel~(1) }
	\begin{columns}[T]
	\begin{column}[T]{5.0cm}
		\includegraphics[width=0.95\textwidth]{img/1664305823396.jpeg}
	\end{column}
	\begin{column}[T]{5.0cm}
		\includegraphics[width=0.95\textwidth]{img/1664305824237.jpeg}
	\end{column}
	\end{columns}~\\
\end{frame}

\begin{frame}
	\frametitle{\titleSubSectionMilieuNaturel~(2) }
	\includegraphics[width=0.95\textwidth]{img/1664305824748.jpeg}
\end{frame}

\begin{frame}
	\frametitle{\titleSubSectionMilieuNaturel~(3) }
	\includegraphics[width=0.95\textwidth]{img/1664305823320.jpeg}
\end{frame}

\begin{frame}
	\frametitle{\titleSubSectionMilieuNaturel~(4) }
	\includegraphics[width=0.95\textwidth]{img/DebuggingInvestigation.jpeg}
\end{frame}

\begin{frame}
	\frametitle{\titleSubSectionMilieuNaturel~(5) }
	\includegraphics[width=0.85\textwidth]{img/GestionDeProjetInformation_Humain.jpeg}
\end{frame}

\begin{frame}
	\frametitle{\titleSubSectionMilieuNaturel~(6) }
	\includegraphics[width=0.95\textwidth]{img/CyberPunkNightCitySkyLine.jpeg}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item \textbf{Mettez votre mauvaise pratique ici !} ; 
