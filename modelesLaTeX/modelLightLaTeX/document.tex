...
\texttt{http://www.example.org/.../}~\\

\textbf{\LARGE What's Up ?} ~\\

\emph{\small par Anne Onymous, le 11 septembre 1337 13:37} ~\\

\textbf{Paragraphe Introduction } ~\\

\begin{minipage}[ht]{7.00cm}
	\includegraphics[width=5.00cm]{img/logo_glider.png}
